...
import importlib
_gs = importlib.import_module("P1_glycogen_smooth")
simulate_glycogen = _gs.simulate_glycogen
glycogen_to_water_lbs = _gs.glycogen_to_water_lbs
G_MAX = _gs.G_MAX
CARB_REF = _gs.CARB_REF
RATE_UP = _gs.RATE_UP
RATE_DOWN = _gs.RATE_DOWN
WATER_RATIO = _gs.WATER_RATIO
GRAMS_PER_LB = _gs.GRAMS_PER_LB
...
def save_output(daily):
    ...
    out_path = ROOT / "analysis" / "P3_daily_weight.csv"
...
def plot_diagnostic(daily):
    ...
    plt.tight_layout()
    out = ROOT / "analysis" / "P3_interpolation_diagnostic.png"
